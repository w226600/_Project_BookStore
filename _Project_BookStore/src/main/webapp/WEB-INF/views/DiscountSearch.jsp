								...
								<div class="col-lg-12 col-md-12">
									<div class="pdpt-bg">
										<div class="pdpt-title">
											<h4 style="background:#FF8000">查詢--折扣系列活動</h4>
										</div>
										<div class="address-body">
											...
											<div class="address-item">																							
												...
												<div class="address-dt-all">
													<h3>活動名稱：活動名稱:${discount.discountEventName}</h3>											
													<p>活動編號：${discount.discountEventId}</p>
													...
													<ul class="action-btns" style="float:right">
														<li><a href='modifyDiscount/${discount.discountEventId}' class="add-address hover-btn" style="background:#FFA042;height:35px">																
															修改活動</a></li>
													</ul>													
												</div>																							
											</div>

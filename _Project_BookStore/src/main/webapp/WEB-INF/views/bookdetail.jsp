...
<html lang="en">
	...
	<head>
		...
		<title>Gambo - Single Product View</title>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div id="sync1" class="owl-carousel owl-theme">
										<div class="item">
											<img width='100' height='200' src="<c:url value='/getPicture/${bookp.bookId}' />" />
										</div>
										<div class="item">
								...
								<div class="col-lg-8 col-md-8">
									<div class="product-dt-right">
										<h2>${bookp.bookName}</h2>
										<div class="no-stock">
											<p class="pd-no">Product No.<span>12345</span></p>
											<p class="stock-qty">目前庫存:${bookp.stock}本</p>
										</div>
										...
										<div class="product-group-dt">
											<ul>
												<li><div class="main-price color-discount">Price:<span>$${bookp.price}</span></div></li>

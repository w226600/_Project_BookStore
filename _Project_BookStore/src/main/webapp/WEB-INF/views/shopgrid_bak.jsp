													...
													<div class="col-lg-12 col-md-12">
														<div class="form-group mb-0">
															<div class="address-btns">
																<button id="btnAdd" type='submit' class="save-btn14 hover-btn">Save</button>
															</div>
														</div>
													</div>
												</div>
					...
					<div class="col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Vegetables
									& Fruits</li>
							</ol>
						</nav>
					</div>
...
<%-- 									</c:forEach> --%>
							...
							<div class="product-left-title" style='padding-left: 160px'>
...
<%-- 											<a href="BuyBook?bookId=${book1.bookId}&qty=3&price=${book1.price}" onclick='checkqty(${book1.bookId})'> --%>

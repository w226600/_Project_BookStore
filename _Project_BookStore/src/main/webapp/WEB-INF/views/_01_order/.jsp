				...
				<div class="category-model-content modal-content">
					...
					<ul class="category-by-cat">
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-1.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-2.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-3.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-4.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-5.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-6.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-7.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-8.svg"
										alt="">
								</div>
						...
						<li><a href="#" class="single-cat-item">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/category/icon-9.svg"
										alt="">
								</div>
		...
		<div class="bs-canvas-body">
			...
			<div class="side-cart-items">
				...
				<div class="cart-item">
					<div class="cart-product-img">
						<img
							src="${pageContext.request.contextPath}/images/product/img-2.jpg"
							alt="">
						<div class="offer-badge">6% OFF</div>
					</div>
					<div class="cart-text">
			...
			<div class="top-header">
				<div class="res_main_logo">
					<a href="index.html"><img
						src="${pageContext.request.contextPath}/images/dark-logo-1.svg"
						alt=""></a>
				</div>
				<div class="main_logo" id="logo">
					<a href="index.html"><img
						src="${pageContext.request.contextPath}/images/logo.svg" alt=""></a>
					<a href="index.html"><img class="logo-inverse"
						src="${pageContext.request.contextPath}/images/dark-logo.svg"
						alt=""></a>
				</div>
				...
				<div class="header_right">
					<ul>
						...
						<li><a href="offers.html" class="offer-link"><i
								class="uil uil-gift"></i>Offers</a></li>
						...
						<li class="ui dropdown"><a href="#" class="opts_account">
								<img
								src="${pageContext.request.contextPath}/images/avatar/img-5.jpg"
							...
							<div class="menu dropdown_account">
								...
								<a href="dashboard_overview.html" class="item channel_item"><i
									...
									class="uil uil-location-point icon__1"></i>My Address</a> <a
							...
							<div class="user-img">
								...
								<div class="img-add">
									<input type="file" id="file"> <label for="file"><i
										class="uil uil-camera-plus"></i></label>
								</div>
							</div>
							<h4>${OrderBean[0].memberNo}</h4>
							<p>
								+91999999999<a href="#"><i class="uil uil-edit"></i></a>
							</p>
							<div class="earn-points">
								<img src="${pageContext.request.contextPath}/images/Dollar.svg"
									alt="">Points : <span>20</span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="left-side-tabs">
							<div class="dashboard-left-links">
								<a href="dashboard_overview.html" class="user-item"><i
									class="uil uil-apps"></i>Overview</a> <a
									href="dashboard_my_orders.html" class="user-item active"><i
									class="uil uil-box"></i>My Orders</a> <a
									href="dashboard_my_rewards.html" class="user-item"><i
									class="uil uil-gift"></i>My Rewards</a> <a
									href="dashboard_my_wallet.html" class="user-item"><i
									class="uil uil-wallet"></i>My Wallet</a> <a
									href="dashboard_my_wishlist.html" class="user-item"><i
									class="uil uil-heart"></i>Shopping Wishlist</a> <a
									href="dashboard_my_addresses.html" class="user-item"><i
									class="uil uil-location-point"></i>My Address</a> <a
									href="sign_in.html" class="user-item"><i
									class="uil uil-exit"></i>Logout</a>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#ordersallmain">所有訂單</a></li>
										<li><a href="<c:url value='ordersmainnopay'/>">未結訂單</a></li>
												...
												<div class="pdpt-bg">
													...
													<div class="order-body10">
														<ul class="order-dtsll">
															...
															<li>
																<div class="order-dt47" style="font-size: 16px;">
																	<h4>訂單編號</h4>
													...
													<div class="track-order">
														<div
															style="display: flex; width: 100%; align-items: stretch; font-size: 16px; justify-content: space-between;">
															<h4
															...
															<c:choose>
																...
																<c:otherwise>
																	<a
																		href='<c:url value='ordersallmain/shippingdata?orderNo=${anOrderBean.orderNo}'/>'>${anOrderBean.shippingNo}</a>
																</c:otherwise>
															</c:choose>
														</div>
													</div>
						...
						<div class="second-row-item-app">
							...
							<ul>
								<li><a href="#"><img class="download-btn"
										src="${pageContext.request.contextPath}/images/download-1.svg"
										alt=""></a></li>
								<li><a href="#"><img class="download-btn"
										src="${pageContext.request.contextPath}/images/download-2.svg"
										alt=""></a></li>
							</ul>
						</div>
							...
							<div class="footer-payments">
								<ul id="paypal-gateway" class="financial-institutes">
									<li class="financial-institutes__logo"><img alt="Visa"
										title="Visa"
										src="${pageContext.request.contextPath}/images/footer-icons/pyicon-6.svg">
									</li>
									<li class="financial-institutes__logo"><img alt="Visa"
										title="Visa"
										src="${pageContext.request.contextPath}/images/footer-icons/pyicon-1.svg">
									</li>
									<li class="financial-institutes__logo"><img
										alt="MasterCard" title="MasterCard"
										src="${pageContext.request.contextPath}/images/footer-icons/pyicon-2.svg">
									</li>
									<li class="financial-institutes__logo"><img
										alt="American Express" title="American Express"
										src="${pageContext.request.contextPath}/images/footer-icons/pyicon-3.svg">
									</li>
									<li class="financial-institutes__logo"><img alt="Discover"
										title="Discover"
										src="${pageContext.request.contextPath}/images/footer-icons/pyicon-4.svg">
									</li>
								</ul>
							</div>
						</div>

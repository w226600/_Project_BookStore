...
<html lang="en">
	...
	<head>
		...
		<title>書果店 - 訂單確認</title>
		
		<!-- Favicon Icon -->
		<link rel="icon" type="${pageContext.request.contextPath}/image/png" href="images/fav.png">
...
<%-- 						<c:set var="discount_sum" value="${discount_sum + (ct.value.qty * ct.value.price * ct.value.discount)}" /> --%>
<%-- 					</c:forEach> --%>
...
<!-- 							alt=""> -->
<%-- 						<div class="offer-badge"><fmt:formatNumber value="${(1 - entry.value.discount)*100}" pattern="###" /> %OFF</div> --%>
<!-- 					</div> -->
<!-- 					<div class="cart-text"> -->
				...
				<div class="row justify-content-center">
					<div class="col-lg-6 col-md-8">
						<div class="order-placed-dt">
							...
							<h2>恭喜訂單成立!</h2>
							<p id="rtnword">感謝您的訂購，我們會盡快將商品送到你的手中，謝謝。</span></p>
							<div class="delivery-address-bg">
								...
								<ul class="address-placed-dt1">
									<li><p><i class="uil uil-map-marker-alt"></i>地址 :<span>${cartMasterBean.address }</span></p></li>
									<li><p><i class="uil uil-phone-alt"></i>連絡電話 :<span>${cartMasterBean.phone }</span></p></li>
									<li><p><i class="uil uil-envelope"></i>Email Address :<span>${cartMasterBean.email }</span></p></li>
									<li><p><i class="uil uil-card-atm"></i>付款方式 :<span id="paymethod">Cash on Delivery</span></p></li>
								</ul>
								<div class="stay-invoice">
									<div class="st-hm">祝您順心!<i class="uil uil-smile"></i></div>
									<a href="clearSession" id="rtnpage1" class="invc-link hover-btn">回到首頁</a>
									<a href="creditcard" id="credit1" class="invc-link hover-btn">信用卡扣款</a>
								</div>								
								
<!-- 								<div class="stay-invoice"> -->
<!-- 									<div class="st-hm">祝您順心!<i class="uil uil-smile"></i></div> -->
<!-- 									<a href="#" class="invc-link hover-btn">收據</a> -->
<!-- 								</div> -->
...
<!-- 	</footer> -->
	...
	jQuery(document).ready(function($){
		var paymethod = ${cartMasterBean.payKind};
		if (paymethod == "03") {
			document.getElementById("paymethod").innerHTML = "貨到付款";
			$('#credit1').hide();
		} else {
			document.getElementById("paymethod").innerHTML = "信用卡付款";
			$('#rtnpage1').hide();
			document.getElementById("rtnword").innerHTML = "請點選信用卡扣款以完成訂單";
		}
	});	
	</script>

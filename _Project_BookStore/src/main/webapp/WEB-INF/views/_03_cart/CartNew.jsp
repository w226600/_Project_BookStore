			...
			<div class="side-cart-items">
				<div class="cart-item">
					<div class="cart-product-img">
						<img src="${pageContext.request.contextPath}/images/product/img-1.jpg" alt="">
				...
				<div class="cart-item">
					<div class="cart-product-img">
						<img src="${pageContext.request.contextPath}/images/product/img-2.jpg" alt="">
						<div class="offer-badge">6% OFF</div>
					</div>
					<div class="cart-text">
						<h4>Product Title Here</h4>
						...
						<div class="owl-carousel offers-banner owl-theme">
							<div class="item">
								<div class="offer-item">								
									<div class="offer-item-img">
										...
										<img src="${pageContext.request.contextPath}/images/banners/offer-1.jpg" alt="">
									</div>
							...
							<div class="item">
								<div class="offer-item">								
									<div class="offer-item-img">
										<div class="gambo-overlay"></div>
										<img src="${pageContext.request.contextPath}/images/banners/offer-2.jpg" alt="">
									</div>
									<div class="offer-text-dt">
										<div class="offer-top-text-banner">
											<p>5% Off</p>
							...
							<div class="item">
								<div class="offer-item">								
									<div class="offer-item-img">
										<div class="gambo-overlay"></div>
										<img src="${pageContext.request.contextPath}/images/banners/offer-3.jpg" alt="">
									</div>
									<div class="offer-text-dt">
										<div class="offer-top-text-banner">
											<p>3% Off</p>
							...
							<div class="item">
								<div class="offer-item">								
									<div class="offer-item-img">	
										<div class="gambo-overlay"></div>
										<img src="${pageContext.request.contextPath}/images/banners/offer-4.jpg" alt="">
									</div>
									<div class="offer-text-dt">
										<div class="offer-top-text-banner">
											<p>2% Off</p>
							...
							<div class="item">
								<div class="offer-item">								
									<div class="offer-item-img">
										<div class="gambo-overlay"></div>
										<img src="${pageContext.request.contextPath}/images/banners/offer-5.jpg" alt="">
									</div>
									<div class="offer-text-dt">
										<div class="offer-top-text-banner">
											<p>3% Off</p>
					...
					<div class="col-md-12">
						<div class="owl-carousel cate-slider owl-theme">
							...
							<div class="item">
								<a href="#" class="category-item">
									<div class="cate-img">
										<img src="${pageContext.request.contextPath}/images/category/icon-10.svg" alt="">
									</div>
									<h4> Meat & Seafood </h4>
								</a>
							</div>
							<div class="item">
								<a href="#" class="category-item">
									<div class="cate-img">
										<img src="${pageContext.request.contextPath}/images/category/icon-11.svg" alt="">
									</div>
									<h4> Electronics </h4>
								</a>
							</div>
					...
					<div class="col-md-12">
						<div class="owl-carousel featured-slider owl-theme">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-3.jpg" alt="">
										<div class="product-absolute-options">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-4.jpg" alt="">
										<div class="product-absolute-options">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-5.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">2% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-6.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">2% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-7.jpg" alt="">
										<div class="product-absolute-options">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-8.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">3% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<a href="#" class="best-offer-item">
							<img src="${pageContext.request.contextPath}/images/best-offers/offer-1.jpg" alt="">
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="#" class="best-offer-item">
							<img src="${pageContext.request.contextPath}/images/best-offers/offer-2.jpg" alt="">
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="#" class="best-offer-item offr-none">
							<img src="${pageContext.request.contextPath}/images/best-offers/offer-3.jpg" alt="">
							<div class="cmtk_dt">
					...
					<div class="col-md-12">
						<a href="#" class="code-offer-item">
							<img src="${pageContext.request.contextPath}/images/best-offers/offer-4.jpg" alt="">
						</a>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="owl-carousel featured-slider owl-theme">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-12.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">2% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-13.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">5% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-14.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">1% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
					...
					<div class="col-md-12">
						<div class="owl-carousel featured-slider owl-theme">
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-10.jpg" alt="">
										<div class="product-absolute-options">
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-9.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">New</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
							...
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="${pageContext.request.contextPath}/images/product/img-15.jpg" alt="">
										<div class="product-absolute-options">
											<span class="offer-badge-1">5% off</span>
											<span class="like-icon" title="wishlist"></span>
										</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="second-row-item-app">
							<h4>Download App</h4>
							<ul>
								<li><a href="#"><img class="download-btn" src="${pageContext.request.contextPath}/images/download-1.svg" alt=""></a></li>
								<li><a href="#"><img class="download-btn" src="${pageContext.request.contextPath}/images/download-2.svg" alt=""></a></li>
							</ul>
						</div>
							...
							<div class="footer-payments">
								<ul id="paypal-gateway" class="financial-institutes">
									<li class="financial-institutes__logo">
									  <img alt="Visa" title="Visa" src="${pageContext.request.contextPath}/images/footer-icons/pyicon-6.svg">
									</li>
									<li class="financial-institutes__logo">
									  <img alt="Visa" title="Visa" src="${pageContext.request.contextPath}/images/footer-icons/pyicon-1.svg">
									</li>
									<li class="financial-institutes__logo">
									  <img alt="MasterCard" title="MasterCard" src="${pageContext.request.contextPath}/images/footer-icons/pyicon-2.svg">
									</li>
									<li class="financial-institutes__logo">
									  <img alt="American Express" title="American Express" src="${pageContext.request.contextPath}/images/footer-icons/pyicon-3.svg">
									</li>
									<li class="financial-institutes__logo">
									  <img alt="Discover" title="Discover" src="${pageContext.request.contextPath}/images/footer-icons/pyicon-4.svg">
									</li>
								</ul>
							</div>
						</div>

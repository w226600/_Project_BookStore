								...
								<div class="col-lg-12 col-md-12">
									<div class="pdpt-bg">
										<div class="pdpt-title">
											<h4 style="background:#FF9D6F">修改--折扣系列活動</h4>
										</div>
													...
													<div class="row">
 														...
 														<!-- key Add -->
 															<div class="form-group">
																<label class="control-label" for='discountEventId'>
																	活動編號 :
																</label>
 						 										<form:input id="discountEventId" path="discountEventId" type='text'  
															...
															<div class="form-group">
																...
																<form:input id="discountFromDate" path="discountFromDate" type='text' 
															...
															<div class="form-group">
																...
																<form:input id="discountFinishDate" path="discountFinishDate" type='text' 
																	class="form-control" style="width:400px" placeholder="請填寫 yyyy-mm-dd hh:mm:ss" required="required"/>			
															</div>
															...
															<div class="form-group">
																...
																<form:textarea name="context" id="discountContent" path="discountContent" style="width:400px;height:300px"
														...
														<div class="form-group">
															 ...
															 <input id="btnAdd" type='submit' class="add-address hover-btn"
																	value="確定修改" onclick="return confirmUpdate('${discountBean.discountEventId};" />
															</div>														

								...
								<div class="col-lg-12 col-md-12">
									<div class="pdpt-bg">
										<div class="pdpt-title">
											<h4 style="background:#FF8000">查詢--折現金系列活動</h4>
										...
										<div class="address-body">
											...
											<div class="address-item">																							
												...
												<div class="address-dt-all">
													...
													<p>活動編號：${shoppingDiscount.shoppingEventId}</p>
													...
													<ul class="action-btns" style="float:right">
														<li><a href='modifyShoppingDiscount/${shoppingDiscount.shoppingEventId}' class="add-address hover-btn" style="background:#FFA042;height:35px">																
															修改活動</a></li>

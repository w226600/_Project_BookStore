...
<!-- 								<span class="user__name">管理者</span> -->
...
<!-- 								<a href="promotion_Manager" class="item channel_item"><i class="uil uil-location-point icon__1"></i>行銷活動管理</a> -->
<!-- 								<a href="bookUpPage" class="item channel_item"><i class="uil uil-location-point icon__1"></i>產品管理</a> -->
...
<!-- 								<li class="nav-item"><a href="index" class="nav-link active" title="Home">Home</a></li> -->
<!-- 								<li class="nav-item"><a href="bookpage" class="nav-link new_item" title="New Products">New Products</a></li> -->
<!-- 								產品頁面 -->
								...
								<div class="offer-item">								
									...
									<div class="offer-text-dt">
										<div class="offer-top-text-banner">
											<p>3% Off</p>
											<div class="top-text-1">全面特價!!</div>
											<span></span>
										</div>
										<a href="bookpage" class="Offer-shop-btn hover-btn">立即購買</a>
									</div>
								</div>
							</div>
							<div class="item">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<c:forEach var='book1' items='${booki}'>
							<div class="item">
								<div class="product-item">
									<a href="single_product_view.html" class="product-img">
										<img src="<c:url value='/getPicture/${book1.bookId}' />" width='100' height='200' alt="">
									...
									<div class="product-text-dt">
										...
										<div class="product-price">$${book1.price} <span>$15</span></div>
										<div class="qty-cart">
											<div class="quantity buttons_added">
												<input type="button" value="-" class="minus minus-btn">
												<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<a href="offers" class="best-offer-item">
							<img src="images/best-offers/homepage1.jpg" alt="無法顯示圖片">
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="offers" class="best-offer-item">
							<img src="images/best-offers/homepage2.jpg" alt="無法顯示圖片">
						</a>
					</div>
					<div class="col-lg-4 col-md-6">
						<a href="ShoppingDiscount" class="best-offer-item offr-none">
							<img src="images/best-offers/book_033.jpg" alt="無法顯示圖片">
							<div class="cmtk_dt">
								<div class="product_countdown-timer offer-counter-text" data-countdown="2020/08/31"></div>
							</div>
						</a>
					</div>
					
					<div class="col-md-12">
						<a href="offers" class="code-offer-item">
							<img src="images/best-offers/summer1.jpg" alt="無法顯示圖片">
						</a>
					</div>

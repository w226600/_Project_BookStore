								...
								<div class="col-lg-12 col-md-12">
									<div class="pdpt-bg">
										<div class="pdpt-title">
											<h4 style="background:#FF9D6F">新增--折現金系列活動</h4>
										</div>
										
							<!-- Add ShoppingDiscount Body -->		
													...
													<div class="row">
 														...
 														<!-- key Add -->
															...
															<div class="form-group">
																...
																<form:input id="shoppingFromDate" path="shoppingFromDate" type='text' value='2019-01-01 00:00:00'

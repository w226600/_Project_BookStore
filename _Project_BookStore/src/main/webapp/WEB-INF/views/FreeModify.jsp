								...
								<div class="col-lg-12 col-md-12">
									<div class="pdpt-bg">
										<div class="pdpt-title">
											<h4 style="background:#FF9D6F">修改--贈品系列活動</h4>
										</div>
													...
													<div class="row">
 														...
 														<!-- key Add -->
 															<div class="form-group">
																<label class="control-label" for='freeBieEventId'>
																	活動編號 :
																</label>
 						 										<form:input id="freeBieEventId" path="freeBieEventId" type='text'  
															...
															<div class="form-group">
																<label class="control-label" for='freeBieEventName'>
 						 										...
 						 										<form:input id="freeBieEventName" path="freeBieEventName" type='text'  
															...
															<div class="form-group">
																...
																<form:input id="freeBieThreshold" path="freeBieThreshold" type='number' min='0' step='50'
															...
															<div class="form-group">
																...
																<form:input id="freeBies" path="freeBies" type='text'
															...
															<div class="form-group">
																...
																<form:input id="freeBieQuota" path="freeBieQuota" type='number' min='0' step='5'
															...
															<div class="form-group">
																...
																<form:input id="freeBieFromDate" path="freeBieFromDate" type='text' 
															...
															<div class="form-group">
																...
																<form:input id="freeBieFinishDate" path="freeBieFinishDate" type='text' 
																	class="form-control" style="width:400px" placeholder="請填寫 yyyy-mm-dd hh:mm:ss" required="required"/>	
															...
															<div class="form-group">
															 ...
															 <input id="btnAdd" type='submit' class="add-address hover-btn"
																	value="確定修改" onclick="return confirmUpdate('${freeBiesBean.freeBieEventId}');" />
															</div>														
